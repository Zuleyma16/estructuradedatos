...
Fuente: El término «metadatos» no tiene una definición única. Según la definición más difundida de metadatos es que son «datos sobre datos».
...
Diferencias entre listas y diccionarios: Las listas son un conjunto de variables que se pueden modificar. *Los diccionarios son como las listas, pero con una mayor facilidad para referirnos a un elemento del diccionario. *Las listas acceden a cada valor por número, mientras que los diccionarios acceden a cada valor por nombre. *Las listas son una estructura de datos que combina una serie de valores, mientras que los diccionarios son un mapa. *Las listas asignan posiciones o índices a valores, mientras que los diccionarios asignan claves significativas a valores.
